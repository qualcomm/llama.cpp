...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
    ...
    // gemma prefill KQV: f16 A (V, contiguous) x f32 B (probs, permuted/non-contiguous),
    ...
    // exercise that path against the CPU reference (was previously uncovered: the other
