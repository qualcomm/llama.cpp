        ...
        uchar mask_hi2)
{
    ...
    if (groupId == 0) {
        ...
        // and would overrun dst into the adjacent tensor (garbage downstream, e.g.
        // mamba2-2.7b ssm_in ne01=10576). No-op / byte-identical when ne01 % 128 == 0
        // (M/2 already a multiple of 64 -> no padding).
