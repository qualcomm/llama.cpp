        ...
        int r3)
{
    ...
    // Clamp the fetch row: if a future specialisation is not a multiple of 128 the
    // x-grid pads past the packed weight and only the stores below are guarded.
    // No-op for every specialisation currently compiled (all ne01 % 128 == 0).
