...
#endif
// IQ2XXS_MV_GRIDIMG=1: read the grid through an image1d_buffer.
//
...
//
// Filled by kernel_iq2xxs_grid_export from the table this kernel compiles in, so the
// host never duplicates it and the two cannot drift.
#ifndef IQ2XXS_MV_GRIDIMG
#define IQ2XXS_MV_GRIDIMG 0
#endif
...
kernel void kernel_mul_mv_iq2_xxs_f32(
    ...
    for (int ib = ix; ib < nb; ib += BLOCK_STRIDE) {
        ...
        for (int row = 0; row < N_DST; row++) {
            ...
            global block_iq2_xxs * xb = (global block_iq2_xxs *)(xrow + rsafe*nb01);
