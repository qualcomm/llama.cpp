...
// ---------------------------------------------------------------------------
// flash_attn_f32_f16_q1_local_tile — alternative decode FA design contributed
// 2026-05-17: one WG per (q_idx, q_head). Stages K/V into __local tiles of
...
// 2026-05-17. Combines the 3 levers identified in the local_tile A/B:
