...
// IQ3XXS_MV_AIMG=1: read the activation through an image1d_buffer (a CL_RGBA/CL_FLOAT
...
// and OFF elsewhere, and GGML_OPENCL_IQ3XXS_MV_AIMG overrides it either way.
