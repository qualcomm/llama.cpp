...
// IQ3S_LM_GRIDIMG=1: read the codebook through an image1d_buffer instead of
// from __constant.
//
...
#ifndef IQ3S_LM_GRIDIMG
#define IQ3S_LM_GRIDIMG 0
#endif

#if IQ3S_LM_GRIDIMG
#define IQ3S_LM_GRID(i) (read_imageui(grid_img, (int)(i)).x)
#else
#define IQ3S_LM_GRID(i) iq3s_grid[(i)]
#endif
...
kernel void kernel_mul_mm_iq3_s_f32_l4_lm(
    ...
    int r2,
    int r3,
    __read_only image1d_buffer_t grid_img   // see IQ3S_LM_GRIDIMG
) {
