...
// ADRENO_OLD_COMPILER is defined by the host (-D) for Adreno parts at or below
// gen level A7X, whose OpenCL compiler (E031.41 on the Adreno 740) miscompiles
// several constructs this kernel used. Conformant compilers -- X1E, A8X/X2E,
// Intel, and every non-Adreno device that builds this program -- take the #else
// branches, which are the original source: the workarounds below cost ~13% on
// the q6_K flat n=1 GEMV where they are not needed.
