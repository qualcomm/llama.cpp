...
struct ggml_backend_opencl_context {
    ...
    cl_program program_gemv_moe_q4_1_f32_ns, program_gemm_moe_q4_1_f32_ns;
...
#endif
        backend_ctx->program_gemv_moe_q4_1_f32_ns =
            build_program_from_source(backend_ctx->context, backend_ctx->device, kernel_src.c_str(), CL_moe_compile_opts);

        CL_CHECK((backend_ctx->kernel_gemv_moe_q4_1_f32_ns = clCreateKernel(backend_ctx->program_gemv_moe_q4_1_f32_ns, "kernel_gemv_moe_q4_1_f32_ns", &err), err));
        GGML_LOG_CONT(".");
    }
...
#endif
        backend_ctx->program_gemm_moe_q4_1_f32_ns =
            build_program_from_source(backend_ctx->context, backend_ctx->device, kernel_src.c_str(), CL_moe_compile_opts);

        CL_CHECK((backend_ctx->kernel_gemm_moe_q4_1_f32_ns = clCreateKernel(backend_ctx->program_gemm_moe_q4_1_f32_ns, "kernel_gemm_moe_q4_1_f32_ns", &err), err));
        GGML_LOG_CONT(".");
    }
